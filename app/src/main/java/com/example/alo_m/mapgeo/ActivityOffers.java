...
public class ActivityOffers extends AppCompatActivity {
    ...
    private Offer selectedPackage; //hold user when we select
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.imv_offers);
        name = findViewById(R.id.edt_name_offers);
        ...
        if(imageUri != null){
            ...
            reference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Offer aOffer = new Offer(UUID.randomUUID().toString(),NAME,DESCRIPTION,PRICE,taskSnapshot.getDownloadUrl().toString());
                    String id = databaseReference.push().getKey();

                    aOffer.setKey(id);
                    Log.i("La clave", aOffer.getKey());
                    databaseReference.child(id).setValue(aOffer);
    ...
    public void viewAllData(View view){
        Intent intent = new Intent(ActivityOffers.this, ViewOffersActivity.class);
