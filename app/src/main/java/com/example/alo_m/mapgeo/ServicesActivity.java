...
public class ServicesActivity extends AppCompatActivity {
    ...
    private Service selectedPackage; //hold user when we select
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView = findViewById(R.id.imv_services);
        name = findViewById(R.id.edt_name_services);
        ...
        if(imageUri != null){
            ...
            reference.putFile(imageUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Service aService = new Service(UUID.randomUUID().toString(),NAME,DESCRIPTION,PRICE,taskSnapshot.getDownloadUrl().toString());
                    String id = databaseReference.push().getKey();

                    aService.setKey(id);
                    Log.i("La clave", aService.getKey());
                    databaseReference.child(id).setValue(aService);
    ...
    public void viewAllData(View view){
        Intent intent = new Intent(ServicesActivity.this, ViewServicesActivity.class);
